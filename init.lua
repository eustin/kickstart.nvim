...
require('lazy').setup {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch current [D]irectory [F]iles' })
      ...
      vim.keymap.set('n', '<leader>r', builtin.registers, { desc = 'Show [R]egisters' })
  ...
  -- debugging
  -- 
  -- see: https://github.com/NeuralNine/config-files/blob/master/.config/nvim/lua/plugins/nvim-dap.lua
  {
